...
const AddQuestion: React.FC<Props> = (props) => {
  ...
  const [displayNameType, setDisplayNameType] =
    useState<DisplayNameType>("userName");
  ...
  return (
    <>
      <div className="lg:pl-6">
        <p className="text-xs my-4">شما هم درباره این بازی پرسش ثبت کنید</p>
        <button
          type="button"
          className="text-sm h-12 rounded block w-full border border-orange-600 text-orange-500 px-5 dark:font-semibold"
          onClick={clickHandle}
        >
          ثبت پرسش
        </button>
                ...
                {[
                  {
                    ...
                    description: (
                      <p>
                        پرسش شما در صفحه محصول با عنوان <strong className="font-semibold"> کاربر مرکز بازی ایران </strong> نمایش داده می‌شود
                      </p>
                    ),
                  },
                  {
                    ...
                    description: (
                      <p>
                        پرسش شما در صفحه محصول با نام <strong className="font-semibold"> {userFullName} </strong>نمایش داده می‌شود
                      </p>
                    ),
                  },
                ].map((a) => (
